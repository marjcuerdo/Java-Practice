 ...
 * BalancingScale.java
 *
 * @version   $Id: BalancingScale.java,v 1.3 2017/09/10 12:41pm $
 *
 * Revisions:
 *
 *	None.
 ...
 * determined set of values. The obtained set is the smallest possible
 * set.
 *
...
class BalancingScale {
	...
	static int weightsArray[] = {50, 25, 40, 10, 25, 7, 10, 5, 2, 1};
    ...
    public static void main (String args []) {	// main program
    	...
    	checkWeight(100);*/
    	checkWeight(40); // total weight 18
	}
